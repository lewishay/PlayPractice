...
class HomeViewSpec extends ViewBaseSpec {
  ...
  object Selectors {
    ...
    def boxElement(row: Int, col: Int) = s"div:nth-child($row) > div:nth-child($col) > a > div > div.col-md-8.side-text"
    ...
    def footerTitle(col: Int) = s"footer > div.footer-above > div > div > div:nth-child($col) > h3"
    def footerInfo(col: Int) = s"footer > div.footer-above > div > div > div:nth-child($col) > p"
